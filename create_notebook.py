...
# Write notebook directly to Evaluation.ipynb and save generator
notebook_json = json.dumps(notebook_dict, indent=1)
notebook_path = os.path.join(os.path.dirname(__file__), 'Evaluation.ipynb')
with open(notebook_path, 'w', encoding='utf-8') as f:
    f.write(notebook_json)
print(f"Successfully generated Evaluation.ipynb at: {notebook_path}")
